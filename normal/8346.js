...
// Id de la boucle d'関閚ement
var mainEventId; // Boucle principale qui v閞ifie les niveau et les fin d'animation fadeOut
...
function main() {
	...
	ctx = document.getElementById('canvas').getContext("2d");
	 ...
	 // animation de d閎ut de jeu
	 welcome(level1);
	 
	 // v閞ifie s'il vient d'y avoir lieu un changement de level
